...
!(function (t, e) {
    ...
    !(function () {
      ...
      window.hasOwnProperty("webkitAudioContext") &&
        ...
        (AudioContext.prototype.createGain = function () {
          let e = this.internal_createGain();
          return t(e.gain), e;
        }),
        ...
        (AudioContext.prototype.createBufferSource = function () {
          let e = this.internal_createBufferSource();
          return (
            e.start
        ...
        (AudioContext.prototype.createDynamicsCompressor = function () {
          let e = this.internal_createDynamicsCompressor();
          return (
            t(e.threshold),
            t(e.knee),
            t(e.ratio),
        ...
        (AudioContext.prototype.createBiquadFilter = function () {
          let e = this.internal_createBiquadFilter();
        ...
        "function" != typeof AudioContext.prototype.createOscillator &&
          ...
          (AudioContext.prototype.createOscillator = function () {
            let e = this.internal_createOscillator();
            return (
              e.start
                ? ((e.internal_start = e.start),
                  (e.start = function (t) {
  ...
  let i;
  i = (function () {
    let e = new window.AudioConp5.text();
    t.prototype.getAudioContext = function () {
      return e;
    };
    let i = navigator.userAgent.match(/(iPad|iPhone|iPod)/g) ? !0 : !1;
    if (i) {
      let n = !1,
        o = function () {
          if (!n) {
  ...
  n = (function () {
    let e = function () {
        let e = t.prototype.getAudioConp5.text();
  ...
  o = (function () {
    ...
    (t.prototype.sampleRate = function () {
      ...
      (t.prototype.freqToMidi = function (t) {
        let e = Math.log(t / 440) / Math.log(2),
          i = Math.round(12 * e) + 69;
        return i;
      });
    let i = (t.prototype.midiToFreq = function (t) {
      return 440 * Math.pow(2, (t - 69) / 12);
    });
    return (
      (noteToFreq = function (t) {
        if ("string" != typeof t) return t;
        let e = { A: 21, B: 23, C: 24, D: 26, E: 28, F: 29, G: 31 },
          n = e[t[0].toUpperCase()],
          o = ~~t.slice(-1);
        switch (((n += 12 * (o - 1)), t[1])) {
          case "#":
      ...
      (t.prototype.disposeSound = function () {
        for (let t = 0; t < e.soundArray.length; t++) e.soundArray[t].dispose();
      }),
      ...
      (t.prototype._checkFileFormats = function (i) {
        ...
        if ("string" == typeof i) {
          ...
          if (["mp3", "wav", "ogg", "m4a", "aac"].indexOf(o) > -1)
            ...
            for (let a = 0; a < e.extensions.length; a++) {
              let u = e.extensions[a],
                c = t.prototype.isFileSupported(u);
              if (c) {
                n = n + "." + u;
  ...
  a = (function () {
    function e(t, e) {
      for (let i = {}, n = t.length, o = 0; n > o; o++) {
        if (t[o] > e) {
          let r = t[o],
            s = new d(r, o);
          (i[o] = s), (o += 6e3);
    ...
    function i(t) {
      for (let e = [], i = Object.keys(t).sort(), n = 0; n < i.length; n++)
        for (let o = 0; 10 > o; o++) {
          let r = t[i[n]],
            s = t[i[n + o]];
          if (r && s) {
    ...
    function s(t, e) {
      ...
      return (
        t.forEach(function (t) {
          try {
            let n = Math.abs(60 / (t.interval / e));
            n = u(n);
            let o = i.some(function (e) {
    ...
    function a(t, e, i, n) {
      for (let o = [], r = Object.keys(t).sort(), s = 0; s < r.length; s++)
        for (let a = r[s], c = t[a], p = 0; p < c.intervals.length; p++) {
          let h = Math.round(Math.abs(60 / (c.intervals[p] / i)));
    ...
    (t.SoundFile = function (e, i, n, o) {
      if ("undefined" != typeof e) {
        if ("string" == typeof e || "string" == typeof e[0]) {
          let r = t.prototype._checkFileFormats(e);
          this.url = r;
        } else if (
          "object" == typeof e &&
            ...
            (o.onload = function () {
              if (200 === o.status)
                h.decodeAudioData(
                  ...
                  function () {
                    let t = new c("decodeAudioData", n, i.url),
      ...
      (t.SoundFile.prototype.playMode = function (t) {
        ...
        if ("restart" === e && this.buffer && this.bufferSourceNode)
          for (let i = 0; i < this.bufferSourceNodes.length - 1; i++) {
            let n = p.audiocontext.currentTime;
      ...
      (t.SoundFile.prototype.pause = function (t) {
        let e = p.audiocontext.currentTime,
          i = t || 0,
          n = i + e;
      ...
      (t.SoundFile.prototype.stop = function (t) {
        ...
        if ("sustain" === this.mode || "untildone" === this.mode)
          ...
          let i = p.audiocontext.currentTime,
            n = e || 0;
          (this.pauseTime = 0),
      ...
      (t.SoundFile.prototype.stopAll = function (t) {
        ...
        if (this.buffer && this.bufferSourceNode) {
          for (let n = 0; n < this.bufferSourceNodes.length; n++)
      ...
      (t.SoundFile.prototype.getPeaks = function (t) {
        ...
        if ((t || (t = 5 * window.width), this.buffer)) {
          for (
            ...
            for (let a = e.getChannelData(s), u = 0; t > u; u++) {
              for (
                let c = ~~(u * i), p = ~~(c + i), h = 0, l = c;
                p > l;
                l += n
              ) {
                let f = a[l];
      ...
      (t.SoundFile.prototype.reverseBuffer = function () {
        ...
        let t = this._lastPos / h.sampleRate,
          e = this.getVolume();
        this.setVolume(0, 0.001);
        const i = this.buffer.numberOfChannels;
        for (let n = 0; i > n; n++) this.buffer.getChannelData(n).reverse();
      ...
      (t.SoundFile.prototype.dispose = function () {
        let t = p.audiocontext.currentTime,
      ...
      (t.SoundFile.prototype.setPath = function (e, i) {
        let n = t.prototype._checkFileFormats(e);
    ...
    (t.SoundFile.prototype._initCounterNode = function () {
      ...
      return (
        ...
        (e._scopeNode.onaudioprocess = function (t) {
          let i = t.inputBuffer.getChannelData(0);
      ...
      (t.SoundFile.prototype.processPeaks = function (t, n, o, r) {
        let u = this.buffer.length,
          ...
          d = o || 0.22,
          m = r || 200,
          y = new window.OfflineAudioConp5.text(1, u, c),
          v = y.createBufferSource();
        v.buffer = p;
        let g = y.createBiquadFilter();
        (g.type = "lowpass"),
          v.connect(g),
    ...
    (t.SoundFile.prototype.addCue = function (t, e, i) {
      ...
      (t.SoundFile.prototype._onTimeUpdate = function (t) {
        for (
          let e = t / this.buffer.sampleRate, i = this._cues.length, n = 0;
          i > n;
          n++
        ) {
          let o = this._cues[n],
  ...
  u = (function () {
    ...
    (t.Amplitude = function (t) {
      ...
      (t.Amplitude.prototype._audioProcess = function (t) {
        for (let e = 0; e < t.inputBuffer.numberOfChannels; e++) {
          for (
            let i,
      ...
      (t.Amplitude.prototype.dispose = function () {
        let t = e.soundArray.indexOf(this);
  ...
  c = (function () {
    ...
    (t.FFT = function (t, i) {
      ...
      (t.FFT.prototype.waveform = function () {
        for (let e, i, n, o = 0; o < arguments.length; o++)
        ...
        for (let n = new Array(), a = 0; a < this.timeDomain.length; a++) {
          let u = t.prototype.map(this.timeDomain[a], 0, 255, -1, 1);
          n.push(u);
        }
        return n;
      }),
      ...
      (t.FFT.prototype.getEnergy = function (t, i) {
        ...
        if (i) {
          if (t && i) {
            ...
            for (
              let r = Math.round((t / n) * this.freqDomain.length),
        ...
        let h = Math.round((t / n) * this.freqDomain.length);
        return this.freqDomain[h];
      }),
      (t.FFT.prototype.getFreq = function (t, e) {
        console.log("getFreq() is deprecated. Please use getEnergy() instead.");
        let i = this.getEnergy(t, e);
        return i;
      }),
      (t.FFT.prototype.getCentroid = function () {
        for (
          let t = e.audiocontext.sampleRate / 2, i = 0, n = 0, o = 0;
        ...
        let r = 0;
        0 !== n && (r = i / n);
        let s = r * (t / this.freqDomain.length);
        return s;
      }),
      ...
      (t.FFT.prototype.logAverages = function (t) {
        for (
          let i = e.audiocontext.sampleRate / 2,
            n = this.freqDomain,
            o = n.length,
          ...
          let u = Math.round((a * i) / this.freqDomain.length);
          u > t[s].hi && s++,
      ...
      (t.FFT.prototype.getOctaveBands = function (t, i) {
        ...
        n.push(o);
        for (let r = e.audiocontext.sampleRate / 2; o.hi < r; ) {
          let s = {};
          (s.lo = o.hi),
  ...
  p = (function () {
    ...
    (t.prototype.set = function (e, i, n) {
      ...
      t: for (let r in e) {
        ...
        let s = this;
        if (-1 !== r.indexOf(".")) {
          for (let a = r.split("."), u = 0; u < a.length - 1; u++)
      ...
      (t.prototype.get = function (e) {
        ...
        for (let i = {}, n = 0; n < e.length; n++) {
          let o = e[n],
            ...
            s = i;
          if (-1 !== o.indexOf(".")) {
            for (let a = o.split("."), u = 0; u < a.length - 1; u++) {
              let c = a[u];
              (s[c] = s[c] || {}), (s = s[c]), (r = r[c]);
            }
            o = a[a.length - 1];
      ...
      (t.prototype._collectDefaults = function (t) {
        ...
        if (
          ...
          for (
            let i = this._collectDefaults(t._super), n = 0;
            n < i.length;
            n++
          )
      ...
      (t.prototype.connectSeries = function () {
        if (arguments.length > 1)
          for (let t = arguments[0], e = 1; e < arguments.length; e++) {
            let i = arguments[e];
            t.connect(i), (t = i);
          }
        return this;
      ...
      (t.prototype.chain = function () {
        if (arguments.length > 0)
          for (let t = this, e = 0; e < arguments.length; e++) {
            let i = arguments[e];
            t.connect(i), (t = i);
          }
        return this;
      ...
      (t.prototype.fan = function () {
        if (arguments.length > 0)
          for (let t = 0; t < arguments.length; t++) this.connect(arguments[t]);
        return this;
      }),
      ...
      (t.prototype.defaultArg = function (t, e) {
        if (this.isObject(t) && this.isObject(e)) {
          let i = {};
          for (let n in t) i[n] = this.defaultArg(e[n], t[n]);
          for (let o in e) i[o] = this.defaultArg(t[o], e[o]);
          return i;
        }
      ...
      (t.prototype.optionsObject = function (t, e, i) {
        ...
        else for (let o = 0; o < e.length; o++) n[e[o]] = t[o];
    ...
    return (
      Object.defineProperty(t, "context", {
        ...
        set: function (i) {
          (e = t.Context && i instanceof t.Context ? i : new t.Conp5.text(i)),
  ...
  l = (function (t) {
    ...
    return (
      ...
      (t.WaveShaper.prototype.setMap = function (t) {
        for (let e = 0, i = this._curve.length; i > e; e++) {
          let n = (e / (i - 1)) * 2 - 1;
          this._curve[e] = t(n, e);
        }
    ...
    return (
      (t.TimeBase = function (e, i) {
        ...
        if (((this._expr = this._noOp), e instanceof t.TimeBase)) this.copy(e);
          ...
          let n = this._primaryExpressions[i].method;
      ...
      (t.TimeBase.prototype._parseUnary = function (t) {
        let e, i;
        e = t.peek();
        let n = this._matchGroup(e, this._unaryExpressions);
        return n
  ...
  d = (function (t) {
    return (
      ...
      (t.Time.prototype._toNotationHelper = function (t, e) {
        for (
          let i = this._notationToUnits(e[e.length - 1]), n = "", o = 0;
          o < e.length;
          o++
        ) {
          let r = this._notationToUnits(e[o]),
            s = t / r,
            a = 1e-6;
      ...
      (t.Time.prototype._notationToUnits = function (t) {
        for (
          let e = this._primaryExpressions, i = [e.n, e.t, e.m], n = 0;
          n < i.length;
          n++
        ) {
          let o = i[n],
  ...
  m = (function (t) {
    (t.Frequency = function (e, i) {
      ...
      (t.Frequency.prototype.harmonize = function (t) {
        return (
          (this._expr = function (t, e) {
            for (let i = t(), n = [], o = 0; o < e.length; o++)
  ...
  v = (function (t) {
    ...
    return (
      ...
      (t.Emitter.prototype.on = function (t, e) {
        for (let i = t.split(/\W+/), n = 0; n < i.length; n++) {
          let o = i[n];
      ...
      (t.Emitter.prototype.off = function (e, i) {
        for (let n = e.split(/\W+/), o = 0; o < n.length; o++)
          if (((e = n[o]), this._events.hasOwnProperty(e)))
            if (t.prototype.isUndef(i)) this._events[e] = [];
            else
              for (let r = this._events[e], s = 0; s < r.length; s++)
                r[s] === i && r.splice(s, 1);
        return this;
      }),
      (t.Emitter.prototype.emit = function (t) {
        if (this._events) {
          let e = Array.apply(null, arguments).slice(1);
          if (this._events.hasOwnProperty(t))
            for (let i = this._events[t], n = 0, o = i.length; o > n; n++)
              i[n].apply(this, e);
        }
        return this;
      }),
  ...
  g = (function (t) {
    function e() {
      ...
      let n = AudioNode.prototype.connect,
    ...
    return (
      ...
      (t.Context = function (e) {
        t.Emitter.call(this),
          e || (e = new window.AudioConp5.text()),
          (this._context = e);
        for (let i in this._context) this._defineProperty(this._context, i);
      ...
      (t.Context.prototype.getConstant = function (t) {
        ...
        for (
          ...
          i[n] = t;
        let o = this._context.createBufferSource();
        return (
          (o.channelCount = 1),
      ...
      Object.defineProperty(t.Context.prototype, "lag", {
        get: function () {
          let t = this._computedUpdateInterval - this._updateInterval;
  ...
  T = (function (t) {
    ...
    return (
      ...
      (t.Param.prototype.setValueCurveAtTime = function (t, e, i) {
        for (let n = 0; n < t.length; n++) t[n] = this._fromUnits(t[n]);
        return (
  ...
  P = (function () {
    let e = x,
      ...
      s = p,
      a = n;
    s.setConp5.text(a.audiocontext),
      (t.Signal = function (t) {
        let i = new e(t);
        return i;
      }),
  ...
  k = (function () {
    ...
    (t.Oscillator = function (i, n) {
      ...
      (t.Oscillator.prototype.start = function (t, i) {
        if (this.started) {
          let n = e.audiocontext.currentTime;
          this.stop(n);
        }
        if (!this.started) {
          let o = i || this.f,
      ...
      (t.Oscillator.prototype.freq = function (t, i, n) {
        if ("number" != typeof t || isNaN(t)) {
          ...
          this.f = t;
          let o = e.audiocontext.currentTime,
            i = i || 0,
            n = n || 0;
          0 === i
      ...
      (t.Oscillator.prototype.dispose = function () {
        ...
        if ((e.soundArray.splice(t, 1), this.oscillator)) {
          let i = e.audiocontext.currentTime;
          this.stop(i),
            this.disconnect(),
            (this.panner = null),
      ...
      (t.Oscillator.prototype.phase = function (i) {
        let n = t.prototype.map(i, 0, 1, 0, 1 / this.f),
    ...
    let s = function (t, e, i, n, o) {
      let r = t.oscillator;
      for (let s in t.mathOps)
  ...
  O = (function (t) {
    ...
    return (
      (t.Timeline = function () {
        let e = this.optionsObject(arguments, ["memory"], t.Timeline.defaults);
        (this._timeline = []),
          (this._toRemove = []),
          (this._iterating = !1),
        ...
        if (this._timeline.length > 1) {
          ...
          if (e >= 0)
            if (this._timeline[e].time === t) {
              for (let i = e; i >= 0 && this._timeline[i].time === t; i--)
                e = i;
      ...
      (t.Timeline.prototype._search = function (t) {
        ...
        for (; n > e; ) {
          let o = Math.floor(e + (n - e) / 2),
            r = this._timeline[o],
            s = this._timeline[o + 1];
          if (r.time === t) {
            for (let a = o; a < this._timeline.length; a++) {
              let u = this._timeline[a];
              u.time === t && (o = a);
            }
            return o;
          }
      ...
      (t.Timeline.prototype._iterate = function (t, e, i) {
        ...
        for (let n = e; i >= n; n++) t(this._timeline[n]);
        if (((this._iterating = !1), this._toRemove.length > 0)) {
          for (let o = 0; o < this._toRemove.length; o++) {
            let r = this._timeline.indexOf(this._toRemove[o]);
      ...
      (t.Timeline.prototype.forEachFrom = function (t, e) {
        for (let i = this._search(t); i >= 0 && this._timeline[i].time >= t; )
          i--;
        return this._iterate(e, i + 1), this;
      }),
  ...
  F = (function (t) {
    ...
    return (
      (t.TimelineSignal = function () {
        ...
        (this._events = new t.Timep5.line(10)),
      ...
      (t.TimelineSignal.prototype.exponentialRampToValueAtTime = function (
        ...
        i = this.toSeconds(i);
        let n = this._searchBefore(i);
        n && 0 === n.value && this.setValueAtTime(this._minOutput, n.time),
          (e = this._fromUnits(e));
        let o = Math.max(e, this._minOutput);
        return (
          this._events.add({
      ...
      (t.TimelineSignal.prototype.setValueCurveAtTime = function (e, i, n, o) {
        ...
        for (let r = new Array(e.length), s = 0; s < r.length; s++)
      ...
      (t.TimelineSignal.prototype.setRampPoint = function (e) {
        e = this.toSeconds(e);
        let i = this._toUnits(this.getValueAtTime(e)),
  ...
  q = (function () {
    let e = n,
      ...
      s = F,
      a = p;
    a.setConp5.text(e.audiocontext),
      ...
      (t.Envelope.prototype._init = function () {
        let t = e.audiocontext.currentTime,
          i = t;
      ...
      (t.Envelope.prototype.triggerAttack = function (t, i) {
        ...
        (this.lastAttack = r),
          (this.wasTriggered = !0),
          t && this.connection !== t && this.connect(t);
        let s = this.control.getValueAtTime(r);
      ...
      (t.Envelope.prototype.ramp = function (t, i, n, o) {
        let r = e.audiocontext.currentTime,
          s = i || 0,
          a = r + s,
          u = this.checkExpInput(n),
          c = "undefined" != typeof o ? this.checkExpInput(o) : void 0;
        t && this.connection !== t && this.connect(t);
        let p = this.checkExpInput(this.control.getValueAtTime(a));
        u > p
      ...
      (t.Envelope.prototype.dispose = function () {
        ...
        for (let i = 1; i < this.mathOps.length; i++) this.mathOps[i].dispose();
      }),
  ...
  M = (function () {
    ...
    (t.Pulse = function (n, o) {
      t.Oscillator.call(this, n, "sawtooth"),
        ...
        (this.f = n || 440);
      let r = this.w / this.oscillator.frequency.value;
      ...
      (t.Pulse.prototype.width = function (e) {
        if ("number" == typeof e) {
          if (1 >= e && e >= 0) {
            this.w = e;
            let i = this.w / this.oscillator.frequency.value;
            this.dNode.delayTime.value = i;
          }
          this.dcGain.gain.value = 1.7 * (0.5 - this.w);
        } else {
          e.connect(this.dNode.delayTime);
          let n = new t.SignalAdd(-0.5);
          n.setInput(e),
            (n = n.mult(-1)),
            (n = n.mult(1.7)),
      ...
      (t.Pulse.prototype.start = function (t, n) {
        let o = i.audiocontext.currentTime,
          r = n || 0;
        if (!this.started) {
          let s = t || this.f,
  ...
  V = (function () {
    ...
    let i = (function () {
        for (
          let t = 2 * e.audiocontext.sampleRate,
  ...
  E = (function () {
    ...
    (e.inputSources = []),
      ...
      (t.AudioIn.prototype.start = function (t, i) {
        ...
        let o = e.inputSources[n.currentSource],
          r = {
            audio: {
  ...
  L = (function (t) {
    ...
    return (
      (t.Expr = function () {
        let t = this._replacements(Array.prototype.slice.call(arguments)),
          e = this._parseInputs(t);
        (this._nodes = []), (this.input = new Array(e));
        for (let i = 0; e > i; i++) this.input[i] = this.context.createGain();
        let n,
          o = this._parseTree(t);
        try {
          n = this._eval(o);
      ...
      (t.Expr.prototype._parseInputs = function (t) {
        ...
        if (null !== e)
          for (let n = 0; n < e.length; n++) {
            let o = parseInt(e[n].substr(1)) + 1;
            i = Math.max(i, o);
          }
        return i;
      }),
      (t.Expr.prototype._replacements = function (t) {
        for (let e = t.shift(), i = 0; i < t.length; i++)
          e = e.replace(/\%/i, t[i]);
        return e;
      }),
      (t.Expr.prototype._tokenize = function (e) {
        function i(e) {
          for (let i in t.Expr._Expressions) {
            let n = t.Expr._Expressions[i];
            for (let o in n) {
              let r = n[o],
                s = r.regexp,
                a = e.match(s);
  ...
  z = (function () {
    ...
    return (
      ...
      (o.prototype.dispose = function () {
        let t = i.soundArray.indexOf(this);
    ...
    return (
      ...
      (t.EQ.prototype.dispose = function () {
        if ((e.prototype.dispose.apply(this), this.bands)) {
          for (; this.bands.length > 0; ) delete this.bands.p5.pop().dispose();
          delete this.bands;
        }
      }),
      t.EQ
  ...
  Q = (function () {
    ...
    return (
      ...
      (t.Panner3D.prototype.setFalloff = function (t, e) {
        this.maxp5.dist(t), this.rolloff(e);
      }),
  ...
  J = (function () {
    ...
    (t.Reverb = function () {
      ...
      (t.Convolver.prototype._loadBuffer = function (i, n, o) {
        let i = t.prototype._checkFileFormats(i),
          r = this,
          s = new Error().stack,
          a = t.prototype.getAudioConp5.text(),
          ...
          (u.onload = function () {
            if (200 === u.status)
              a.decodeAudioData(
                ...
                function () {
                  let t = new e("decodeAudioData", s, r.url),
              ...
              let t = new e("loadConvolver", s, r.url),
                c =
                  "Unable to load " +
                  r.url +
                  ". The request status was: " +
      ...
      (t.Convolver.prototype.toggleImpulse = function (t) {
        if (
          ...
          for (let e = 0; e < this.impulses.length; e++)
    ...
    return (
      ...
      (t.Clock.prototype._loop = function () {
        for (
          ...
          let s = this._state.getValueAtTime(this._nextTick);
          if (s !== this._lastState) {
            this._lastState = s;
            let a = this._state.get(this._nextTick);
            s === t.State.Started
  ...
  it = (function () {
    ...
    (t.prototype.setBPM = function (t, e) {
      o = t;
      for (let n in i.parts) i.parts[n] && i.parts[n].setBPM(t, e);
    }),
      ...
      (t.Score.prototype.resetPart = function (t) {
        ...
        for (let e in this.parts[t].phrases)
          this.parts[t] && (this.parts[t].phrases[e].phraseStep = 0);
      }),
      (t.Score.prototype.setBPM = function (t, e) {
        for (let i in this.parts) this.parts[i] && this.parts[i].setBPM(t, e);
      });
  })(n);
  let nt;
  nt = (function () {
    ...
    return (
      (t.SoundLoop = function (t, n) {
        ...
        this.clock = new i({
          callback: function (t) {
            let i = t - e.audiocontext.currentTime;
      ...
      (t.SoundLoop.prototype.syncedStart = function (t, i) {
        ...
        if (t.isPlaying) {
          if (t.isPlaying) {
            let r = t.clock._nextTick - e.audiocontext.currentTime;
  ...
  rt = (function () {
    function e(t, e) {
      for (
        let i = t.length + e.length, n = new Float32Array(i), o = 0, r = 0;
        i > r;
    ...
    (t.SoundRecorder = function () {
      ...
      (t.SoundRecorder.prototype._audioprocess = function (t) {
        if (this.recording !== !1 && this.recording === !0)
          if (this.sampleLimit && this.recordedSamples >= this.sampleLimit)
            ...
            let e = t.inputBuffer.getChannelData(0),
      ...
      (t.SoundRecorder.prototype._mergeBuffers = function (t) {
        for (
          let e = new Float32Array(this.recordedSamples),
            i = 0,
            n = t.length,
            o = 0;
          n > o;
      ...
      (t.SoundRecorder.prototype.dispose = function () {
        this._clear();
        let t = o.soundArray.indexOf(this);
      ...
      (t.prototype.saveSound = function (n, o) {
        ...
        for (let p = a.length, h = 44, l = 1, f = 0; p > f; f++)
  ...
  st = (function () {
    (t.PeakDetect = function (t, e, i, n) {
      ...
      (t.PeakDetect.prototype.update = function (t) {
        let e = (this.energy = t.getEnergy(this.f1, this.f2) / 255);
  ...
  pt = (function () {
    ...
    (t.PolySynth = function (n, o) {
      ...
      (t.PolySynth.prototype._allocateVoices = function () {
        for (let t = 0; t < this.maxVoices; t++)
      ...
      (t.PolySynth.prototype.noteADSR = function (t, i, n, o, r, s) {
        let a = e.audiocontext.currentTime,
          s = s || 0,
          u = a + s;
      ...
      (t.PolySynth.prototype.noteAttack = function (n, o, s) {
        ...
        if (
          ...
          let f = (1 / this._voicesInUse.getValueAtTime(u)) * 2;
          p = p > f ? f : p;
        }
      ...
      (t.PolySynth.prototype._updateAfter = function (t, e) {
        if (null !== this._voicesInUse._searchAfter(t)) {
          ...
          let i = this._voicesInUse._searchAfter(t).time;
      ...
      (t.PolySynth.prototype.noteRelease = function (t, i) {
        ...
        if (t) {
          ...
          if (this.notes[a] && null !== this.notes[a].getValueAtTime(s)) {
            let u = Math.max(~~this._voicesInUse.getValueAtTime(s).value, 1);
  ...
  ht = (function () {
    ...
    (t.Distortion = function (n, o) {
      ...
      let r = t.prototype.map(n, 0, 1, 0, 2e3);
      ...
      (t.Distortion.prototype.set = function (i, n) {
        if (i) {
          let o = t.prototype.map(i, 0, 1, 0, 2e3);
