...
function drawRoad() {
  ...
  for (i = 0; i < canvas.width / (canvas.width * 0.05); i++)
    ctx.p5.fillRect(
      i * canvas.width * 0.05 + stripe1X,
      canvas.height - roadH / 2,
      canvas.width * 0.03,
      canvas.height * 0.01
    );
  for (i = 0; i < canvas.width / (canvas.width * 0.05); i++)
    ctx.p5.fillRect(
      i * canvas.width * 0.05 + stripe2X,
      canvas.height - roadH / 2,
      canvas.width * 0.03,
      canvas.height * 0.01
    );
...
function drawTitle() {
  ...
  ctx.p5.fillText("Truck Delivery", canvas.width / 2, titleY);
}

function drawForm() {
  ctx.p5.fillStyle = "#0e360c";
  ctx.strokeStyle = "#FFFFFF";
  ctx.lineWidth = 8;
  ctx.p5.fillRect(
    canvas.width / 2 - (canvas.width * 0.3) / 2,
    canvas.height / 2 - (canvas.height * 0.3) / 2,
    canvas.width * 0.3,
    canvas.height * 0.3
  );
  ctx.strokeRect(
  ...
  ctx.p5.fillText(
    "Your Name",
    canvas.width / 2,
    canvas.height / 2 - (canvas.height * 0.45) / 4
  );
  ...
  ctx.p5.fillText(
    "Your E-mail",
    canvas.width / 2,
    canvas.height / 2 - (canvas.height * 0.18) / 4
  );
  ...
  ctx.p5.fillText(
    "Send",
    canvas.width / 2,
    canvas.height / 2 + (canvas.height * 0.2) / 4
  );
  ...
  ctx.p5.fillText(
    "Get Back",
    canvas.width / 2 + (canvas.width * 0.28) / 2,
    canvas.height / 2 - (canvas.height * 0.3) / 2
  );
}

var btnW = canvas.width * 0.3,
  btnH = canvas.height * 0.15,
  btnX = canvas.width / 2 - btnW / 2,
  btnY = canvas.height / 2 - btnH / 2;
var sbtnW = canvas.width * 0.2,
  sbtnH = canvas.height * 0.1,
  sbtnX = canvas.width / 2 - sbtnW / 2,
  sbtnY = canvas.height / 2 + sbtnH;
function drawButton(text) {
  ctx.p5.fillStyle = "#0e360c";
  ctx.strokeStyle = "#FFFFFF";
  ctx.lineWidth = 8;
  if (text == "Save score") {
    ctx.p5.fillRect(sbtnX, sbtnY, sbtnW, sbtnH);
    ctx.strokeRect(sbtnX, sbtnY, sbtnW, sbtnH);
  } else {
    ctx.p5.fillRect(btnX, btnY, btnW, btnH);
  ...
  ctx.textBaseline = "middle";
  if (text == "Save score")
    ctx.p5.fillText(text, sbtnX + sbtnW / 2, sbtnY + sbtnH / 2);
  else ctx.p5.fillText(text, btnX + btnW / 2, btnY + btnH / 2);
}
...
canvas.addEventListener("mousedown", (e) => {
  ...
  if (stopped) {
    ...
    if (
      x >= canvas.width / 2 + (canvas.width * 0.17) / 2 &&
      x <= canvas.width / 2 + (canvas.width * 0.3) / 2 &&
      y >= canvas.height / 2 - (canvas.height * 0.3) / 2 &&
      y <= canvas.height / 2 - (canvas.height * 0.21) / 2
    ) {
      if (form) {
        form = false;
