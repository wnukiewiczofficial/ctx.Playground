...
let owl = {
  ...
  still: function () {
    ...
    wrapText(
      "Click or touch the wisdom owl for your mood tips!",
      canvas.width / 2,
      canvas.height / 2,
      mobile ? canvas.width / 2 : canvas.width / 4,
      fontSize
    );
    ctx.restore();
  },
...
function Input(e) {
  ...
  if (checkForClick(e, owl)) {
    ...
    if (TipsUsed < 3) {
      ...
      words_said.push(
        new Word(
          "I am busy giving tips to others also, please check in after 30 minutes!",
          "red"
        )
      );
    }
